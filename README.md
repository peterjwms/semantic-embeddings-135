...
<p>The repo contains code for gathering and pre-processing data, but also has the data generated by these files store in the [datasets](main/datasets) directory</p>

<p>Read the accompanying paper [here relative link](main/Applying Semantic and Syntactic Information to Contextual Embeddings.pdf)</p>
